...
func main() {
	...
	hostname := pick(rng, []string{
		"macbook-pro-demo", "mbp-eng-01", "mbp-alice", "dev-laptop-02", "mbp-sandbox",
	})
	serial := pick(rng, []string{
		"C02XK1AFJGH5", "C02Y4NKHJGH7", "FVFXQ2NBJGH5", "C02ZR0NWMD6T", "C02WN1ABHV29",
	})
	osVer := pick(rng, []string{"15.3.2", "15.4", "15.4.1", "15.5", "14.7.5"})

	if err := writeReport(results, hostname, serial, osVer, outPath); err != nil {
